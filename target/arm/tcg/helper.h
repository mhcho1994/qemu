...
DEF_HELPER_3(cortexm_st, void, env, ptr, i32)
DEF_HELPER_2(cortexm_ld, i32, env, ptr)
DEF_HELPER_3(cortexa_st, void, env, ptr, i64)
DEF_HELPER_2(cortexa_ld, i64, env, ptr)
DEF_HELPER_4(arm_log_fp, void, env, ptr, ptr, i32)
